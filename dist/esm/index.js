...
var HeroCarousel = function HeroCarousel(_ref) {
  ...
  return jsxs("div", {
    ...
    }), slidesArray.length > 1 && jsxs(Fragment, {
      children: [jsx("button", {
