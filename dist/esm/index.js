...
var css_248z$e = "@import url(\"https://fonts.googleapis.com/css2?family=Nunito:ital,wght@0,200..1000;1,200..1000&display=swap\");\n/*========================= Theme Colors =========================*/\n/* Transparent Colors */\n/* Additional Colors */\n/* Neutral Colors */\n/* Disabled Colors */\n/* Alerts */\n/* Gradients */\n/*========================= Typography =========================*/\n/* Headings */\n/*========================= Spacing =========================*/\n/*========================= Breakpoints =========================*/\n/*========================= Borders & Shadows =========================*/\n/*========================= Transitions =========================*/\n/*========================= Containers =========================*/\n.buttonClass {\n  display: inline-flex;\n  align-items: center;\n  justify-content: center;\n  font-weight: bold;\n  text-align: center;\n  border: 2px solid transparent;\n  user-select: none;\n  transition: all 0.4s ease-in-out;\n  cursor: pointer;\n  letter-spacing: 0.5px;\n  line-height: 1.5;\n  /* Default Button Colors */\n  background-color: #FF9F1A;\n  color: #ffffff;\n  border-color: #FF9F1A;\n  border-radius: 8px;\n  box-shadow: rgba(0, 0, 0, 0.15) 0px 1px 3px;\n  /* Variant Styles */\n  /* Secondary Variant */\n  /* Accent Variant */\n  /* Highlight Variant */\n  /* Outline Variant */\n  /* Ghost Variant */\n  /* Responsive Behavior */\n}\n.buttonClass:hover {\n  opacity: 0.85;\n}\n.buttonClass:active {\n  transform: scale(0.98);\n}\n.buttonClass.disabled {\n  pointer-events: none;\n  opacity: 0.6;\n  background-color: #E0E0E0;\n  color: #9E9E9E;\n  border-color: #BDBDBD;\n}\n.buttonClass.xs {\n  font-size: 8px;\n  padding: 4px 8px;\n  height: 25px;\n  min-width: 20px;\n  border-radius: 3px;\n}\n.buttonClass.sm {\n  font-size: 12px;\n  padding: 6px 12px;\n  height: 25px;\n  min-width: 20px;\n  border-radius: 4px;\n}\n.buttonClass.md {\n  font-size: 16px;\n  padding: 10px 16px;\n  height: 35px;\n  min-width: 30px;\n  border-radius: 8px;\n}\n.buttonClass.lg {\n  font-size: 20px;\n  padding: 14px 20px;\n  height: 52px;\n  min-width: 120px;\n  border-radius: 12px;\n}\n.buttonClass.secondary {\n  background-color: #FFB516;\n  border-color: #FFB516;\n  color: #000000;\n}\n.buttonClass.accent {\n  background-color: #2EC4B6;\n  border-color: #2EC4B6;\n  color: #ffffff;\n}\n.buttonClass.highlight {\n  background-color: #00ADA9;\n  border-color: #00ADA9;\n  color: #ffffff;\n}\n.buttonClass.outline {\n  background-color: transparent;\n  border-color: currentColor;\n  color: inherit;\n}\n.buttonClass.ghost {\n  background-color: transparent;\n  border: none;\n  color: inherit;\n  box-shadow: none;\n}\n@media (max-width: 768px) {\n  .buttonClass.md {\n    font-size: 12px;\n    padding: 8px 14px;\n  }\n  .buttonClass.lg {\n    font-size: 16px;\n    padding: 12px 18px;\n  }\n}";
...
var useSafeLocation = function useSafeLocation() {
  var context = useContext(UNSAFE_LocationContext);
...
var SideBar = function SideBar(_ref) {
  var _theme$colors, _theme$shadows;
  var logo = _ref.logo,
  ...
  var location = useSafeLocation();
  var theme = useTheme() || {};
  var _sideBarStyle$bg = sideBarStyle.bg,
    bg = _sideBarStyle$bg === void 0 ? ((_theme$colors = theme.colors) === null || _theme$colors === void 0 || (_theme$colors = _theme$colors.neutral) === null || _theme$colors === void 0 ? void 0 : _theme$colors.white) || "#fff" : _sideBarStyle$bg,
  ...
  return jsxs(Fragment, {
    children: [!isMobileOpen && jsxs("div", {
...
var css_248z$a = "@import url(\"https://fonts.googleapis.com/css2?family=Nunito:ital,wght@0,200..1000;1,200..1000&display=swap\");\n/*========================= Theme Colors =========================*/\n/* Transparent Colors */\n/* Additional Colors */\n/* Neutral Colors */\n/* Disabled Colors */\n/* Alerts */\n/* Gradients */\n/*========================= Typography =========================*/\n/* Headings */\n/*========================= Spacing =========================*/\n/*========================= Breakpoints =========================*/\n/*========================= Borders & Shadows =========================*/\n/*========================= Transitions =========================*/\n/*========================= Containers =========================*/\n.scroll-indicator {\n  position: absolute;\n  top: 80%;\n  left: 50%;\n  transform: translateX(-50%);\n  z-index: 1050;\n  display: flex;\n  align-items: center;\n  justify-content: center;\n  gap: 8px;\n  font-family: \"Nunito\", sans-serif;\n  font-weight: 600;\n  color: #FF9F1A;\n  cursor: pointer;\n  user-select: none;\n  transition: 0.4s ease-in-out;\n  width: 100%;\n}\n.scroll-indicator .text {\n  font-size: 20px;\n}\n@media (max-width: 1200px) {\n  .scroll-indicator .text {\n    font-size: 16px;\n  }\n}\n@media (max-width: 992px) {\n  .scroll-indicator .text {\n    font-size: 12px;\n  }\n}\n@media (max-width: 768px) {\n  .scroll-indicator .text {\n    font-size: 14px;\n  }\n}\n@media (max-width: 576px) {\n  .scroll-indicator .text {\n    font-size: 12px;\n  }\n}\n\n.arrow {\n  width: 20px;\n  height: 20px;\n  font-size: 28px;\n  animation: bounce 1.5s infinite;\n}\n\n.arrow:first-child {\n  animation-delay: 0s;\n}\n\n.arrow:last-child {\n  animation-delay: 0.3s;\n}\n\n@keyframes bounce {\n  0%, 100% {\n    transform: translateY(0);\n  }\n  50% {\n    transform: translateY(6px);\n  }\n}";
...
var ScrollIndicator = function ScrollIndicator(_ref) {
  ...
  var renderContent = function renderContent() {
    switch (direction) {
      case "up":
        return jsxs(Fragment, {
          children: [jsx(SvgUpArrow, _objectSpread2({
      ...
      case "left":
        return jsxs(Fragment, {
          children: [jsx(SvgLeftArrow, _objectSpread2({
            className: "arrow bounce",
            style: arrowStyle
          }, arrowProps)), jsx("span", _objectSpread2(_objectSpread2({
            className: "text",
      ...
      case "right":
        return jsxs(Fragment, {
          children: [jsx("span", _objectSpread2(_objectSpread2({
            className: "text",
            style: textStyle
          }, textProps), {}, {
            children: text
          })), jsx(SvgRightArrow, _objectSpread2({
            className: "arrow bounce",
            style: arrowStyle
          }, arrowProps))]
        });
...
var HeroCarousel = function HeroCarousel(_ref) {
  ...
  var slidesArray = React__default.Children.toArray(children).flatMap(function (child) {
    return /*#__PURE__*/React__default.isValidElement(child) && child.type === React__default.Fragment ? React__default.Children.toArray(child.props.children) : [child];
  });
  ...
  return jsxs("div", {
    ...
    }), slidesArray.length > 1 && showNavButtons && jsxs(Fragment, {
      children: [jsx("button", {
...
var PricingCarousel = function PricingCarousel(_ref) {
  ...
  var _useState = useState(0),
    ...
    currentIndex = _useState2[0],
    setCurrentIndex = _useState2[1];
  var totalCards = React__default.Children.count(children);
  var theme = useTheme() || {};
  var styles = useMemo(function () {
...
var css_248z = ".image-carousel {\n  width: 100%;\n  overflow: hidden;\n  position: relative;\n  text-align: center;\n}\n.image-carousel .carousel-title {\n  margin-bottom: 1rem;\n  font-size: 1.25rem;\n  font-weight: 700;\n}\n.image-carousel .carousel-track {\n  display: flex;\n  transition: transform 0.5s ease-in-out;\n}\n.image-carousel .carousel-slide {\n  flex-shrink: 0;\n  display: flex;\n  justify-content: center;\n  align-items: center;\n}\n.image-carousel .carousel-slide .carousel-image {\n  width: 100%;\n  height: 100%;\n  object-fit: cover;\n  border-radius: 12px;\n}\n.image-carousel .carousel-dots {\n  margin-top: 1rem;\n  display: flex;\n  justify-content: center;\n  gap: 8px;\n}\n.image-carousel .carousel-dots .dot {\n  width: 10px;\n  height: 10px;\n  border-radius: 50%;\n  cursor: pointer;\n  transition: background-color 0.3s ease;\n}";
