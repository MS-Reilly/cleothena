...
var ThemeContext = /*#__PURE__*/React2.createContext(theme);
...
var SimpleButton = function SimpleButton(_ref) {
  ...
  var themedStyles = React2.useMemo(function () {
...
function useHref(to, { relative } = {}) {
  ...
  let { basename, navigator: navigator2 } = React2__namespace.useContext(NavigationContext);
...
function useRoutesImpl(routes, locationArg, dataRouterState, future) {
  ...
  let { navigator: navigator2, static: isStatic } = React2__namespace.useContext(NavigationContext);
...
var NavLink = React2__namespace.forwardRef(
  function NavLinkWithRef({
    ...
    let { navigator: navigator2, basename } = React2__namespace.useContext(NavigationContext);
...
var useSafeLocation = function useSafeLocation() {
  var context = React2.useContext(LocationContext);
...
var SafeLink = function SafeLink(_ref) {
  ...
  var routerContext = React2.useContext(LocationContext);
  if (!routerContext) {
  ...
  return jsxRuntime.jsx(Link, _objectSpread2(_objectSpread2({
    to: to
  }, rest), {}, {
    children: children
  }));
...
var SafeNavLink = function SafeNavLink(_ref) {
  ...
  return jsxRuntime.jsx(NavLink, _objectSpread2(_objectSpread2({
    to: to,
    className: className,
    style: style
  }, rest), {}, {
...
var SidebarItem = function SidebarItem(_ref) {
  ...
  var item = _ref.item,
    isOpen = _ref.isOpen;
  var _useState = React2.useState(false),
    _useState2 = _slicedToArray(_useState, 2),
...
var SvgClose = function SvgClose(props) {
  return /*#__PURE__*/React2__namespace.createElement("svg", _extends$1({
    xmlns: "http://www.w3.org/2000/svg",
    width: 512,
    height: 512,
    viewBox: "0 0 64 64"
  }, props), _path || (_path = /*#__PURE__*/React2__namespace.createElement("path", {
...
var SvgHamburger = function SvgHamburger(props) {
  return /*#__PURE__*/React2__namespace.createElement("svg", _extends({
    xmlns: "http://www.w3.org/2000/svg",
    width: 512,
    height: 512,
    viewBox: "0 0 16 16"
  }, props), _g || (_g = /*#__PURE__*/React2__namespace.createElement("g", {
    "data-name": 31
  }, /*#__PURE__*/React2__namespace.createElement("path", {
